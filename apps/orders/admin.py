...
class PanierAdmin(admin.ModelAdmin):
    list_display = ('user', 'partenaire', 'nb_lignes', 'updated_at', 'created_at')
...
class CommandeAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {
            'fields': ('numero', 'user', 'partenaire', 'statut', 'raison_refus'),
        }),
        (_('Livraison'), {
        ...
        (_('Notes & annulation'), {
            'fields': ('notes_client', 'notes_partenaire', 'annulee_par'),
            'classes': ('collapse',),
        }),
        (_('Dates clés'), {
